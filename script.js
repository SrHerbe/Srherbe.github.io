...
downloadBtn.addEventListener("click", () => {
    ...
    // Crea un objeto URL con el objeto Blob creado
    const url = URL.createObjectURL(blob);

    // Crea un elemento <a> con el atributo href configurado con el objeto URL creado
    const link = document.createElement("a");
    link.href = url;

    // Configura el atributo download del elemento <a> con el nombre del archivo que deseas descargar
    link.download = "resultados.csv";

    // Dispara un evento click en el elemento <a> para iniciar la descarga del archivo
    link.click();
});
